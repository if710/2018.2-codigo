package br.ufpe.cin.if710.systemservices.notification
...
class NotificationManagerActivity : Activity() {
    ...
    private val soundURI = Uri.parse("android.resource://br.ufpe.cin.if710.systemservices/" + R.raw.alarm_rooster)
    ...
    internal var mContentView = RemoteViews("br.ufpe.cin.if710.systemservices", R.layout.custom_notification)
    internal var mCustomActionView = RemoteViews("br.ufpe.cin.if710.systemservices", R.layout.custom_notification_action)
